export const createDefaultBusinessSettings = () => ({
  ...
  general: {
    ...
    footer_1: '2026 © GoKab.',
    footer_2: 'Design & Develop by GoKab',
    default_lat: '22.7196',
    default_lng: '75.8577',
    logo: '',
    favicon: '',
  ...
  account_type_settings: {
    ...
    delivery_module_globally_enabled: '1',
    pooling_module_globally_enabled: '1',
    copy_individual: 'Individual Driver: Single vehicle owned & driven by you.',
    copy_vendor: 'Vendor: Small fleet owner with 2 to 4 vehicles.',
    copy_super_fleet_owner: 'Super Fleet Owner: Enterprise fleet manager with 5+ vehicles.',
  },
});
