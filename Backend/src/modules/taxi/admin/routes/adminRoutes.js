...
// Public route: rider-facing booking pages fetch fare rules before/without admin auth
...
adminRouter.get('/admin/wallet/drivers/ledger', authenticate(['admin']), getDriverWalletLedger);
...
import {
  ...
  getRideModulesController,
  createRideModuleController,
  updateRideModuleController,
  deleteRideModuleController,
  getSupportChannelsController,
  createSupportChannelController,
  updateSupportChannelController,
  deleteSupportChannelController,
  getTierAuditLogsController,
} from '../controllers/adminController.js';
...
adminRouter.put('/admin/driver-subscriptions/plans/:id', updateSubscriptionPlan);
adminRouter.delete('/admin/driver-subscriptions/plans/:id', deleteSubscriptionPlan);

adminRouter.get('/admin/ride-modules', getRideModulesController);
adminRouter.post('/admin/ride-modules', createRideModuleController);
adminRouter.patch('/admin/ride-modules/:id', updateRideModuleController);
adminRouter.put('/admin/ride-modules/:id', updateRideModuleController);
adminRouter.delete('/admin/ride-modules/:id', deleteRideModuleController);

adminRouter.get('/admin/support-channels', getSupportChannelsController);
adminRouter.post('/admin/support-channels', createSupportChannelController);
adminRouter.patch('/admin/support-channels/:id', updateSupportChannelController);
adminRouter.put('/admin/support-channels/:id', updateSupportChannelController);
adminRouter.delete('/admin/support-channels/:id', deleteSupportChannelController);

adminRouter.get('/admin/tiers/audit-logs', getTierAuditLogsController);

import {
  getAccountTypeSettingsController,
  updateAccountTypeSettingsController,
  overrideDriverAccountTypeController,
  getAccountTypeMigrationReportController,
  getHeatmapAnalyticsController,
  getGodsEyeFleetController,
} from '../controllers/adminController.js';

adminRouter.get('/admin/account-type-settings', getAccountTypeSettingsController);
adminRouter.patch('/admin/account-type-settings', updateAccountTypeSettingsController);
adminRouter.post('/admin/drivers/:id/override-account-type', authenticate(['admin']), overrideDriverAccountTypeController);
adminRouter.get('/admin/account-type-migration-report', getAccountTypeMigrationReportController);
adminRouter.get('/admin/heatmap/analytics', getHeatmapAnalyticsController);
adminRouter.get('/admin/gods-eye/fleet', getGodsEyeFleetController);
