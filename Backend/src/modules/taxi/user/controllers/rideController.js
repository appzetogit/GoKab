...
export const submitDriverRiderRating = async (req, res) => {
  const ride = await submitDriverRatingForRider({
    rideId: req.params.rideId,
    driverId: req.auth.sub,
    rating: req.body.rating,
  });
