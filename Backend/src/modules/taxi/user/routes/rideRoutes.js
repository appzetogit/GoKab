...
rideRouter.get('/', authenticateOrResolveUser(['user', 'driver', 'owner']), asyncHandler(listMyRides));
...
rideRouter.get('/active/me', authenticateOrResolveUser(['user', 'driver', 'owner']), asyncHandler(getMyActiveRide));
...
rideRouter.get('/:rideId', authenticateOrResolveUser(['user', 'driver', 'owner']), asyncHandler(getRideById));
...
rideRouter.patch('/:rideId/rider-rating', authenticate(['driver']), asyncHandler(submitDriverRiderRating));
