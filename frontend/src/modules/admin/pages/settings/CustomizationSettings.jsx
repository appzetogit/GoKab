      ...
      <div className="max-w-[1400px] mx-auto p-4 md:p-6 space-y-4 animate-in fade-in duration-700">
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden p-5">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3 mb-8">
              ...
              <ToggleField label="Daily Driver Online Selfie Verification" name="enable_daily_driver_selfie" value={settings.enable_daily_driver_selfie} onChange={handleChange} />
           </div>
