...
const BusBookingManager = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="grid gap-4 md:gap-6 xl:grid-cols-[minmax(0,1.25fr)_minmax(0,0.75fr)]">
        <div className="rounded-[32px] border border-slate-100 bg-white p-4 md:p-6 shadow-sm">
        ...
        <div className="space-y-6">
          <div className="rounded-[32px] border border-slate-100 bg-white p-4 md:p-6 shadow-sm">
            ...
            {loading ? (
              ...
              <>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:grid-cols-5">
                  {seatLayout.map((seat) => {
      ...
      <section className="rounded-[32px] border border-slate-100 bg-white p-4 md:p-6 shadow-sm">
        <div className="mb-5 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
