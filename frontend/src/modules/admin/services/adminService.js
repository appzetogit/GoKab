...
export const adminService = {
  ...
  createSubscriptionPlan: (payload) => api.post('/admin/driver-subscriptions/plans/create', payload),
  updateSubscriptionPlan: (id, payload) => api.patch(`/admin/driver-subscriptions/plans/${id}`, payload),
  deleteSubscriptionPlan: (id) => api.delete(`/admin/driver-subscriptions/plans/${id}`),
  getRideModules: () => api.get('/admin/ride-modules'),
  createRideModule: (payload) => api.post('/admin/ride-modules', payload),
  updateRideModule: (id, payload) => api.patch(`/admin/ride-modules/${id}`, payload),
  deleteRideModule: (id) => api.delete(`/admin/ride-modules/${id}`),
  getSupportChannels: () => api.get('/admin/support-channels'),
  createSupportChannel: (payload) => api.post('/admin/support-channels', payload),
  updateSupportChannel: (id, payload) => api.patch(`/admin/support-channels/${id}`, payload),
  deleteSupportChannel: (id) => api.delete(`/admin/support-channels/${id}`),
  getTierAuditLogs: () => api.get('/admin/tiers/audit-logs'),
  getSubscriptionSettings: () => api.get('/admin/driver-subscriptions/settings'),
  updateSubscriptionSettings: (payload) => api.post('/admin/driver-subscriptions/settings', payload),
  getVehicleTypes: (typeFilter = '') => api.get(`/admin/vehicle-types${typeFilter ? `?transport_type=${typeFilter}` : ''}`),
  ...
  getPendingPoolingVehicles: (search = '') => api.get('/admin/pooling-vehicles', { params: { status: 'pending', search: search || undefined } }),
  ...
  /**
   * Account Type Settings & Migration Report
   */
  getAccountTypeSettings: () => api.get('/admin/account-type-settings'),
  updateAccountTypeSettings: (data) => api.patch('/admin/account-type-settings', data),
  overrideDriverAccountType: (id, data) => api.post(`/admin/drivers/${id}/override-account-type`, data),
  getAccountTypeMigrationReport: () => api.get('/admin/account-type-migration-report'),
  getHeatmapAnalytics: (params) => api.get('/admin/heatmap/analytics', { params }),
  getGodsEyeFleet: (params) => api.get('/admin/gods-eye/fleet', { params }),
};
