...
const DriverDeleteAccount = () => {
  ...
  const accountLabel = isOwner ? 'owner' : 'driver';
  const CONSEQUENCES = [
    `Your ${accountLabel} account will be marked inactive with a soft delete`,
    'You will be logged out on this device',
    isOwner
      ? 'You cannot manage drivers or accept ride assignments with this account after deletion'
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      clearDriverAuthState();
      setSuccess(`Your ${accountLabel} account was soft deleted and you have been logged out.`);
      ...
      <header className="bg-white/90 backdrop-blur-md px-5 pt-10 pb-4 sticky top-0 z-20 border-b border-white/80 shadow-[0_4px_20px_rgba(15,23,42,0.05)]">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <h1 className="text-[19px] font-black tracking-tight text-red-600">Delete {isOwner ? 'Owner' : 'Driver'} Account</h1>
          </div>
        </div>
      </header>
      ...
      <div className="px-5 pt-4 space-y-4">
        ...
        <MotionDiv initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <p className="text-[14px] font-black text-red-700 leading-tight">Delete {accountLabel} account</p>
        ...
        {showConfirm && (
          <>
            ...
            <MotionDiv initial={{ scale: 0.92, opacity: 0, y: 40 }} animate={{ scale: 1, opacity: 1, y: 0 }} exit={{ scale: 0.92, opacity: 0, y: 40 }}
              ...
              <p className="text-[13px] font-bold text-slate-500 mb-1 leading-relaxed">Your {accountLabel} account will be marked inactive instead of being permanently removed.</p>
