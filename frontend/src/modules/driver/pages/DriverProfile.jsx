...
const DriverProfile = () => {
    ...
    const isOwner = location.pathname.startsWith('/taxi/owner');
    ...
    const openLegal = (type) => {
        const contentMap = {
            driver_app: {
                ...
                Icon: UserPlus,
                description: 'Join the GoKab fleet as a certified driver.',
                content: `GoKab is always looking for professional, dedicated drivers to join our growing ecosystem. 

Steps to apply:
1. Ensure you have a valid Commercial Driving License.
2. Visit the GoKab Driver Onboarding center or use the Mobile App.
...
5. Once approved, you can start accepting rides and managing your earnings via the dashboard.`
            ...
            terms: {
                ...
                Icon: FileText,
                description: 'General rules for using the GoKab platform.',
                content: `By using the GoKab platform, you agree to comply with all applicable transport regulations and our safety standards.
...
• Platform Fees: GoKab charges a service fee for every successful booking handled.
• Account Security: You are responsible for keeping your credentials and biometric data secure.`
            ...
            privacy: {
                ...
                content: `GoKab takes data security seriously. We collect specific information to ensure safety and service quality.
            ...
            <div className="px-6 py-4 mt-6">
                <div className="rounded-[28px] border border-slate-100 bg-slate-50/50 p-6">
                    ...
                    <div className="space-y-5">
                        <a href="mailto:support@gokab.com" className="flex items-center gap-4 group">
                            ...
                            <div>
                                ...
                                <p className="text-[14px] font-bold text-slate-800">support@gokab.com</p>
                            </div>
                        </a>
