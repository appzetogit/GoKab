    ...
    <div className="min-h-screen bg-[#FBFBF6] font-sans text-gray-900">
      ...
      <div className="fixed top-0 left-0 right-0 bg-[#CFE8C9]/90 backdrop-blur-md z-50 border-b border-gray-200 shadow-sm">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center gap-4">
            ...
            <span className="font-bold text-sm uppercase tracking-widest text-[#2F5F43]">Our Blog</span>
        </div>
      </div>
      ...
      <div className="bg-[#2F5F43] text-white pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-black tracking-tight mb-6">
                Latest <span className="text-[#F2D34F]">News & Articles</span>
            </h1>
      ...
      <div className="max-w-6xl mx-auto px-6 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogPosts.map((post) => (
                <div key={post.id} className="bg-[#CFE8C9] rounded-3xl overflow-hidden shadow-sm border border-gray-100 group hover:shadow-xl hover:-translate-y-2 transition-all duration-300 flex flex-col">
                    <div className="relative h-56 overflow-hidden">
                        ...
                        />
                        <div className="absolute top-4 right-4 bg-[#F2D34F] text-[#2F5F43] text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wide">
                            {post.category}
                        </div>
                    </div>
                    <div className="p-8 flex flex-col flex-1">
                        ...
                        <h3 className="font-bold text-2xl mb-3 leading-snug text-[#2F5F43] group-hover:text-[#F2D34F] transition-colors">{post.title}</h3>
                        <p className="text-gray-800 leading-relaxed mb-6 flex-1">{post.excerpt}</p>
                        <button className="flex items-center gap-2 text-sm font-bold text-[#2F5F43] group-hover:text-[#F2D34F] transition-colors mt-auto">
