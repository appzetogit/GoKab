...
const legalContent = {
  terms: {
    ...
    icon: ScrollText,
    intro:
      'These Terms & Conditions govern the use of the GoKab website, app, and booking services. By using the platform, you agree to follow these terms whenever you browse, register, book, cancel, or pay for a service.',
    sections: [
      {
        title: 'Use of the platform',
        body:
          'GoKab provides technology services for ride booking, vehicle-based transport support, and related mobility services. Availability can vary by city, vehicle type, demand, operating hours, and serviceability.',
      },
      {
        title: 'Eligibility',
        bullets: [
      ...
      },
      {
        ...
        body:
          'GoKab may suspend, restrict, or terminate access where there is fraud, abusive conduct, repeated policy violations, non-payment, chargeback misuse, or legal/regulatory risk.',
      },
      {
        title: 'Liability and service interruptions',
        body:
          'GoKab works to keep the service reliable, but delays may happen because of traffic, weather, technical downtime, route closures, law-and-order issues, or third-party failures. To the extent permitted by law, GoKab is not responsible for indirect or consequential loss arising from such interruptions.',
      },
      {
        title: 'Contact',
        body:
  ...
  privacy: {
    ...
    icon: ShieldCheck,
    intro:
      'This website is managed by GoKab. This Privacy Policy explains what information we collect, why we collect it, how we use it, and the steps we take to protect it when you use the GoKab website or connected services.',
    sections: [
      {
      ...
      },
      {
        ...
        body:
          'Payments may be processed through third-party payment partners. GoKab does not intentionally store full card data on the website. We use reasonable administrative and technical safeguards to protect user information, but no internet-based system can be guaranteed to be fully secure.',
      },
      {
      ...
      },
      {
        ...
        body:
          'GoKab may revise this Privacy Policy from time to time. Continued use of the website after an update means you accept the revised policy.',
      },
    ],
  },
  refund: {
    ...
    icon: ReceiptText,
    intro:
      'This page explains refund eligibility, cancellation timelines, and indicative prices for the main vehicle types available on the GoKab platform. Refunds are reviewed based on service status, time of cancellation, and payment mode.',
    sections: [
      {
      ...
      },
      {
        ...
        bullets: [
          ...
          'GoKab may ask for screenshots, transaction references, or additional verification before approval.',
        ],
      },
      {
  ...
  cancellation: {
    ...
    icon: Scale,
    intro:
      'This page summarizes how cancellations are handled across GoKab booking categories.',
    sections: [
      {
